...
export default function Home() {
  return (
    <div style={{ fontFamily: "var(--font-inter), Inter, sans-serif", color: "#0E1D33", background: "#FFFFFF", overflowX: "hidden" }}>
      ...
      <header style={{ position: "fixed", top: 0, left: 0, width: "100%", height: 64, zIndex: 50, background: "rgba(255,255,255,0.82)", backdropFilter: "blur(14px)", WebkitBackdropFilter: "blur(14px)", borderBottom: "1px solid #E9EEF1" }}>
        <nav style={{ maxWidth: 1200, height: "100%", margin: "0 auto", padding: "0 24px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 24 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 30 }}>
            ...
            <a href="#solucion" style={{ textDecoration: "none", color: "#43566A", fontSize: 14, fontWeight: 500 }}>Pilares</a>
            <a href="#resultados" style={{ textDecoration: "none", color: "#43566A", fontSize: 14, fontWeight: 500 }}>Impacto</a>
            <a href="#contacto" style={{ textDecoration: "none", color: "#43566A", fontSize: 14, fontWeight: 500 }}>Contacto</a>
            <a href="#contacto" style={{ textDecoration: "none", display: "inline-flex", alignItems: "center", gap: 8, background: "#20C463", color: "#06281A", fontSize: 13.5, fontWeight: 600, padding: "9px 18px", borderRadius: 999, boxShadow: "0 4px 14px rgba(32,196,99,0.28)" }}>
      ...
      {/* HERO */}
      <section id="top" style={{ position: "relative", background: "radial-gradient(120% 90% at 80% 0%,#0F2A40 0%,#0A1828 45%,#081320 100%)", color: "#EAF1F4", padding: "128px 24px 84px", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", position: "relative", display: "grid", gridTemplateColumns: "minmax(0,1.05fr) minmax(0,0.95fr)", gap: 48, alignItems: "center" }}>
          <div>
            ...
            <h1 style={{ fontFamily: "var(--font-sora), Sora, sans-serif", fontWeight: 700, fontSize: "clamp(40px,5.2vw,62px)", lineHeight: 1.04, letterSpacing: "-0.03em", margin: "0 0 22px", color: "#FFFFFF" }}>
            ...
            <p style={{ fontSize: 18, lineHeight: 1.6, color: "#A9BBC7", maxWidth: 540, margin: "0 0 34px", fontWeight: 400 }}>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 30 }}>
              <div><div style={{ fontFamily: "var(--font-sora), Sora, sans-serif", fontWeight: 600, fontSize: 24, color: "#FFFFFF" }}>+85</div><div style={{ fontSize: 12.5, color: "#8094A2" }}>agentes en producción</div></div>
              <div style={{ width: 1, background: "rgba(255,255,255,0.12)" }} />
              <div><div style={{ fontFamily: "var(--font-sora), Sora, sans-serif", fontWeight: 600, fontSize: 24, color: "#FFFFFF" }}>−42%</div><div style={{ fontSize: 12.5, color: "#8094A2" }}>tiempo de ciclo</div></div>
              <div style={{ width: 1, background: "rgba(255,255,255,0.12)" }} />
              <div><div style={{ fontFamily: "var(--font-sora), Sora, sans-serif", fontWeight: 600, fontSize: 24, color: "#FFFFFF" }}>3.500+</div><div style={{ fontSize: 12.5, color: "#8094A2" }}>profesionales formados</div></div>
            </div>
          </div>

          <div style={{ position: "relative", height: 480 }}>
            <HeroCanvas />
            <div className="animate-float" style={{ position: "absolute", top: 34, right: 8, display: "flex", alignItems: "center", gap: 11, background: "rgba(12,28,42,0.72)", backdropFilter: "blur(10px)", border: "1px solid rgba(46,212,119,0.25)", borderRadius: 14, padding: "13px 16px", boxShadow: "0 16px 40px rgba(0,0,0,0.35)" }}>
            ...
            <div className="animate-float2" style={{ position: "absolute", bottom: 42, left: 0, background: "rgba(12,28,42,0.72)", backdropFilter: "blur(10px)", border: "1px solid rgba(255,255,255,0.12)", borderRadius: 14, padding: "14px 18px", boxShadow: "0 16px 40px rgba(0,0,0,0.35)" }}>
      ...
      {/* PROBLEMA */}
      <section style={{ scrollMarginTop: 80, background: "#F6F8F9", padding: "88px 24px", borderBottom: "1px solid #EAEFF2" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(5,1fr)", gap: 16 }}>
            {[
              ...
              <div key={title} style={{ background: "#FFFFFF", border: "1px solid #EAEFF2", borderRadius: 14, padding: 22 }}>
      ...
      {/* SOLUCIÓN */}
      <section id="solucion" style={{ scrollMarginTop: 80, background: "#FFFFFF", padding: "90px 24px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(5,1fr)", gap: 18 }}>
            {[
              ...
              <div key={title} style={{ position: "relative", background: dark ? "#0E1D33" : "#FFFFFF", border: `1px solid ${dark ? "#0E1D33" : "#E9EEF1"}`, borderRadius: 16, padding: "26px 22px", display: "flex", flexDirection: "column" }}>
      ...
      {/* RESULTADOS */}
      <section id="resultados" style={{ scrollMarginTop: 80, position: "relative", background: "radial-gradient(120% 120% at 15% 0%,#0F2A40 0%,#0A1828 50%,#081320 100%)", color: "#EAF1F4", padding: "90px 24px", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", position: "relative" }}>
          <div style={{ maxWidth: 680, margin: "0 auto 54px", textAlign: "center" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(5,1fr)", gap: 18 }}>
            {[
              ...
              <div key={i} style={{ background: highlight ? "linear-gradient(135deg,rgba(32,196,99,0.16),rgba(14,138,130,0.12))" : "rgba(255,255,255,0.04)", border: `1px solid ${highlight ? "rgba(46,212,119,0.3)" : "rgba(255,255,255,0.1)"}`, borderRadius: 16, padding: "28px 22px", textAlign: "center" }}>
      ...
      {/* CONTACTO */}
      <section id="contacto" style={{ scrollMarginTop: 80, background: "#F6F8F9", padding: "90px 24px" }}>
        <div style={{ maxWidth: 1080, margin: "0 auto", display: "grid", gridTemplateColumns: "minmax(0,0.9fr) minmax(0,1.1fr)", gap: 52, alignItems: "start" }}>
          <div>
          ...
          <div style={{ background: "#FFFFFF", border: "1px solid #EAEFF2", borderRadius: 18, padding: 32, boxShadow: "0 18px 44px rgba(14,29,51,0.07)" }}>
            <ContactForm />
          </div>
        </div>
      </section>
      ...
      <footer style={{ background: "#081320", color: "#9DB0BF", padding: "56px 24px 32px" }}>
        ...
        <div style={{ maxWidth: 1200, margin: "24px auto 0", display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: 12, fontSize: 12.5, color: "#5C7184" }}>
