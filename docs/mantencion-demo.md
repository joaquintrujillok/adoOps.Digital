                                                  ...
                                                  └▶ OpenAI (extracción de incidencia)
                                                      └▶ Neon (incidencias + ordenes_trabajo)
                                                          └▶ responde por WhatsApp (validación)
                                                              └▶ Dashboard /torrecontrol/mantencion
```
...
| `app/torrecontrol/mantencion/page.tsx` | Dashboard (KPIs, incidencias, órdenes de trabajo) |
...
4. **Dev**: `npm run dev` → http://localhost:3000/torrecontrol/mantencion
...
4. Todo aparece en vivo en `/torrecontrol/mantencion`.
